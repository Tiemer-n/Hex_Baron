        ...
        do {
            ...
            for (String c : commands) {
                ...
                if (!validCommand) {
                    ...
                    if (digSawLocation.equals("")) {
                        digSawLocation = items.get(1);
                    }
                    if (items.get(0).equals("saw") && items.get(1).equals(digSawLocation)) {
                        validSawCommands += 1;
                    } else if (items.get(0).equals("dig") && items.get(1).equals(digSawLocation)) {
                        validDigCommands += 1;
                    }
                    if (player1Turn) {
                    ...
                    if (validSawCommands == 3) {
                        ...
                        grid.makeField(Integer.parseInt(digSawLocation));
                    } else if (validDigCommands == 3) {
                        if (player1Turn) {
...
class HexGrid {
    ...
    public void makeField(int tileIndex) {
        tiles.get(tileIndex).setTerrain(" ");
    }
